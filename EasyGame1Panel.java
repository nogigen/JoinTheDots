...
public class EasyGame1Panel extends JPanel{
   //Variables
   AudioClip click;
...
// Constructor
   public EasyGame1Panel(String name,String mode,HelpfulMethods info , int id) throws FileNotFoundException {
      this.info = info;
      this.id = id;
      this.name = name;
      this.mode = mode;
   ...
   public void createComponents() throws FileNotFoundException {
      ...
      easy1Panel = new EasyDraw1("GAME 1",info,id);
      easy1Panel.draw();
      easy1Panel.setBounds(0,0,750,600);
   ...
   private class GameListener implements ActionListener{
      ...
      public void actionPerformed(ActionEvent e){
         ...
         if(easy1Panel.getIsOver()){
            ...
            gameWon = true;
            repaint();
            score = easy1Panel.getScore()+seconds;
            ...
            info.getallPlayers().get(id - 1).seteasyGame2(1);
