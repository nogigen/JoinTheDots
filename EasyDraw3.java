...
public class EasyDraw3 extends JPanel {
   //Variables
   HelpfulMethods info;
   ...
   //Constructor
   public EasyDraw3(String gameMode,HelpfulMethods info , int id){
      this.info = info;
      this.id = id;
      setLayout(null);
   ...
   public void draw() {
      try {
         ...
         if(gameMode.equals("GAME 3")){
            
            EasyGameDotsCollection EGame3collection = new EasyGameDotsCollection();
            
            x =  EGame3collection.getx3Coordinate();
            y =  EGame3collection.gety3Coordinate();
   ...
   /**
    * This method sets wrongMove boolean to giving condition
    * @param wrongMove is the boolean that user gaves
    */
   ...
   /**
    * This method sets wrongMove boolean to giving condition
    * @return returns true or false depending on the situations
    */
   public boolean getwrongMove() {
      return wrongMove;
   }
   /**
    * This method sets score 
    * @param score is the score that user gives
    */
   ...
   /**
    * This method gives back wrong move number
    * @return  retruns back wrong move Counter
    */ 
